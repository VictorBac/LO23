...
public class FormController {
    ...
    private void formSend(ActionEvent event){
        ...
        if (errors.isEmpty()){ // Toutes les valeurs sont correctement remplies
            ...
            //TODO on attend que data ait mis à jour son constructeur
            //ihmTable.getDataInterface().tableToCreate(new Table(tableName, null, spectator, spectatorChat, playerMax, playerMin, abandon, miseMax, tempsMax, ante, moneyMax));
        }
    }
